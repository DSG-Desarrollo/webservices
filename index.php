...
<body class="hold-transition sidebar-mini layout-fixed">
    <div class="wrapper">
        ...
        <div class="preloader flex-column justify-content-center align-items-center">
            <img class="animation__shake" src="dist/img/ESCUDO_LOGO_DSG_2020_FONDO_BLANCO.png" alt="ESCUDO_LOGO_DSG_2020_FONDO_BLANCO" height="120" width="120">
        </div>
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            <a href="#" class="brand-link">
                <img src="dist/img/new_logo.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
                <span class="brand-text font-weight-light">DSG</span>
            </a>
            ...
            <div class="sidebar os-host os-theme-light os-host-overflow os-host-overflow-y os-host-resize-disabled os-host-scrollbar-horizontal-hidden os-host-transition">
                ...
                <div class="os-content-glue" style="margin: 0px -8px; width: 249px; height: 717px;"></div>
                <!--CONTENIDO DEL MENU-->
                <div id="main-sidebar" class="os-padding"></div>
                <!--CONTENIDO DEL MENU-->
                ...
                <div class="os-scrollbar os-scrollbar-vertical os-scrollbar-auto-hidden">
                    <div class="os-scrollbar-track">
                        <div class="os-scrollbar-handle" style="height: 52.833%; transform: translate(0px);"></div>
                    </div>
                </div>
        ...
        <footer class="main-footer">
            <strong>Copyright &copy; 2014-2021 <a href="https://adminlte.io">DSG Centroamerica y Panamá</a>.</strong>
    ...
    <script type="text/javascript" src="resources/DataTables/Buttons-2.2.3/js/buttons.bootstrap5.min.js"></script>
